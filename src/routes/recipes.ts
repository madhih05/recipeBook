...
/**
 * PUT /recipes/:id
 * Update a recipe (requires authentication and recipe ownership).
 ...
 * Save or unsave a recipe to the authenticated user's profile.
 * Toggles the saved state (if saved, removes it; if not saved, adds it).
 */
